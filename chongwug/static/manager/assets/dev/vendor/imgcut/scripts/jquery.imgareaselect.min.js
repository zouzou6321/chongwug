(function($) {
	...
	$.imgAreaSelect = function(img, options) {
		...
		function doUpdate(resetKeyPress) {adjust();
		...
		function setOptions(newOptions) {
			...
			if(newOptions.x1 != null) {setSelection(newOptions.x1, newOptions.y1, newOptions.x2, newOptions.y2);
		...
		this.remove = function() {setOptions({
				disable : true
			});
