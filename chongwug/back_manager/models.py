...
class pet(models.Model):
    farm = models.ForeignKey(pet_farm,blank=True)
    mam_id = models.ForeignKey(pet_mam,blank=True)
    dad_id = models.ForeignKey(pet_dad,blank=True)
    ...
    #卖出时间
    sale_time = models.TimeField(blank=True)
...
class ad(models.Model):
    ...
    img_url = models.URLField()
    #广告点击后的跳转地址
    tar_url = models.URLField(blank=True)
    #广告价格
