...
from manager.views import manage_supplie_add_view,manage_supplie_mod_view,address_handle_view,manage_home_view,manage_ad_select_view,manage_pet_farm_add_view,manage_ad_add_view,manage_ad_del_view,manage_ad_pic_upload_view,manage_ad_picpre_view
