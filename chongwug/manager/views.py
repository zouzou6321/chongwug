...
def manage_pet_farm_mod_view(request):
    if adapters.manage_authentication(request) == False:
        return HttpResponseRedirect(MANAGE_ROOT)
    data = adapters.manage_home_data_get(request)
    return render_to_response('manager/tpl/manage_pet_farm.html',data)
def manage_pet_farm_picadd_view(request):
    ...
    return render_to_response('manager/tpl/manage_pet_farm_picadd.html',page_data,context_instance=RequestContext(request))
...
def manage_nestofpet_picadd_view(request):
    ...
    data = adapters.manage_home_data_get(request)
    page_data['manager'] = data['manager']
    return render_to_response('manager/tpl/manage_pet_picadd.html',page_data,context_instance=RequestContext(request))
...
def manage_ad_view(request):
    if adapters.manage_authentication(request) == False:
        return HttpResponseRedirect(MANAGE_ROOT)
    data = adapters.manage_home_data_get(request)
    return render_to_response('manager/tpl/manage_ad.html',data)

def manage_nestofpet_view(request):
    if adapters.manage_authentication(request) == False:
        return HttpResponseRedirect(MANAGE_ROOT)
    data = adapters.manage_home_data_get(request)
    return render_to_response('manager/tpl/manage_pet.html',data)
...
def manage_nestofpet_add_view(request):
    ...
    data = adapters.manage_home_data_get(request)
    page_data['manager'] = data['manager']
    return render_to_response('manager/tpl/manage_pet_add.html',page_data,context_instance=RequestContext(request))
...
def manage_manager_view(request):
    if adapters.manage_authentication(request) == False:
        return HttpResponseRedirect(MANAGE_ROOT)
    data = adapters.manage_home_data_get(request)
    return render_to_response('manager/tpl/manage_manager.html',data,context_instance=RequestContext(request))
