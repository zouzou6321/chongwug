...
from petfarm.views import address_handle_view,manage_nestofpet_mod_view,manage_nestofpet_picdel_view,manage_pet_farm_picdel_view,manage_nestofpet_pic_upload_view
