...
from petfarm.views import manage_pwdforgot_view,manage_regist_picadd_view,manage_regist_view,address_handle_view,manage_nestofpet_mod_view,manage_nestofpet_pic_upload_view
