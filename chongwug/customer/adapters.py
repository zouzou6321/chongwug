...
def buy_home_adapter(request):
    ...
    #获取首页需要展示的广告信息
    ads = ad.objects.filter(Q(type__exact = 'buy_home',dele__exact = False,start_time__lte = datetime.datetime.now,end_time__gte = datetime.datetime.now)).order_by('prince')
